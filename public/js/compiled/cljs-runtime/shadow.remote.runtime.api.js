...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17564 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17564(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_17565 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_17565(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_17566 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_17566(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_17567 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_17567(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17568 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17568(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17569 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17569(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__17541,callback){
var map__17542 = p__17541;
var map__17542__$1 = cljs.core.__destructure_map(map__17542);
var input = map__17542__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17542__$1,new cljs.core.Keyword(null,"code","code",1586293142));
