...
var o13082 = temp__5802__auto__;
var temp__5802__auto____$1 = (o13082["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o13083 = temp__5802__auto____$1;
return (o13083["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12043__auto__ = f;
return (o__12043__auto__["toString"]).call(o__12043__auto__);
} else {
return "";
}
}catch (e13104){var _ = e13104;
return "";
}});
...
try{var o__12043__auto___13357 = t;
(o__12043__auto___13357["cljs$lang$ctorPrWriter"]).call(o__12043__auto___13357,t,writer);
}catch (e13121){var __13358 = e13121;
}
...
var char_code = (function (){var o__12043__auto__ = (new String(char$));
return (o__12043__auto__["charCodeAt"]).call(o__12043__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12043__auto__ = String;
return (o__12043__auto__["fromCharCode"]).call(o__12043__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13122 = num_code;
switch (G__13122) {
case (1):
return (185);
...
var o__12043__auto__ = String;
return (o__12043__auto__["fromCharCode"]).call(o__12043__auto__,superscript_code);
});
/**
...
}catch (e13126){var _e__12096__auto__ = e13126;
return false;
}})())){
...
var vec__13127 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13127,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var o13155 = temp__5802__auto__;
var temp__5802__auto____$1 = (o13155["dependencies_"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o13156 = temp__5802__auto____$1;
return (o13156["nameToPath"]);
} else {
return null;
}
} else {
...
var len__5769__auto___13370 = arguments.length;
var i__5770__auto___13371 = (0);
while(true){
if((i__5770__auto___13371 < len__5769__auto___13370)){
args__5775__auto__.push((arguments[i__5770__auto___13371]));

var G__13372 = (i__5770__auto___13371 + (1));
i__5770__auto___13371 = G__13372;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13174){
var vec__13176 = p__13174;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13176,(0),null);
...
var G__13373 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__13374 = cljs.core.butlast(remaining_tokens);
name_tokens = G__13373;
remaining_tokens = G__13374;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13163){
var G__13164 = cljs.core.first(seq13163);
var seq13163__$1 = cljs.core.next(seq13163);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13164,seq13163__$1);
}));
...
var vec__13185 = cljs.core.split_with((function (p1__13184_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__13184_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13185,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13185,(1),null);
...
var vec__13192 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13192,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13192,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__13376 = cljs.core.rest(remaining_tokens);
var G__13377 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__13376;
name_tokens = G__13377;
continue;
} else {
...
var vec__13200 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13200,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13200,(1),null);
var vec__13203 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13203,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13203,(1),null);
var vec__13206 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13206,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13206,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13206,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13206,(3),null);
...
var vec__13225 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13225,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13225,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13225,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13225,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13225,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13225,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__13231 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13231,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13231,(1),null);
var vec__13234 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13234,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13234,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__13237 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__13237) : devtools.munging.parse_fn_info_deep.call(null,G__13237));
})()));
}
} else {
return fn_info;
...
var G__13386 = (arity + (1));
var G__13387 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13238){
var vec__13239 = p__13238;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13239,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13239,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13242_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__13242_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13243_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__13243_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___13397 = arguments.length;
var i__5770__auto___13398 = (0);
while(true){
if((i__5770__auto___13398 < len__5769__auto___13397)){
args__5775__auto__.push((arguments[i__5770__auto___13398]));

var G__13399 = (i__5770__auto___13398 + (1));
i__5770__auto___13398 = G__13399;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13246){
var vec__13247 = p__13246;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13247,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13244){
var G__13245 = cljs.core.first(seq13244);
var seq13244__$1 = cljs.core.next(seq13244);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13245,seq13244__$1);
}));
...
var map__13257 = options;
var map__13257__$1 = cljs.core.__destructure_map(map__13257);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13257__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13257__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13257__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13257__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13258 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13258,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13258,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13258,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13258,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13258,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13258,(5),null);
...
var o__12043__auto__ = f;
return (o__12043__auto__["getBasis"]).call(o__12043__auto__);
});
/**
...
}catch (e13268){var _e__12096__auto__ = e13268;
...
var G__13418 = (obj[cljs.core.first(path)]);
var G__13419 = cljs.core.rest(path);
obj = G__13418;
path = G__13419;
continue;
} else {
...
var _STAR_ = (function (accum,p__13327){
var vec__13328 = p__13327;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13328,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13328,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13334){
var vec__13335 = p__13334;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13335,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13335,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13335,(2),null);
...
var post_process = (function (p__13340){
var vec__13341 = p__13340;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13341,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13341,(1),null);
...
return (obj[cljs.core.first(p1__13338_SHARP_)]);
}),sorted_matches);
