...
var G__13412 = devtools.prefs.pref(v);
v = G__13412;
continue;
} else {
return v;
...
}catch (e13379){var _e__12096__auto__ = e13379;
return false;
}})();
...
}catch (e13382){var _e__12096__auto__ = e13382;
return false;
}})();
...
}catch (e13384){var _e__12096__auto__ = e13384;
return false;
}}
}
});
...
var vec__13389 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13389,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13389,(1),null);
...
return cljs.core.some((function (p1__13396_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13396_SHARP_);
}),template);
});
