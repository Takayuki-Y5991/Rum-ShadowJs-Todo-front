...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13848 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13848(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13849 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13849(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13850 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13850(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13851 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13851(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13852 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13852(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13853 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13853(reader);
}
});
...
var G__13868 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13869 = s.append(c);
c = G__13868;
s = G__13869;
continue;
}
