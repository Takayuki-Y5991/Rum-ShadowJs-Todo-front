...
var i_17419 = (0);
while(true){
if((i_17419 < arr.length)){
(arr[i_17419] = null);

var G__17420 = (i_17419 + (1));
i_17419 = G__17420;
continue;
} else {
}
...
var i_17427 = (self__.level + (1));
while(true){
if((i_17427 <= (new_level + (1)))){
(update[i_17427] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_17429 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17429[i]));
} else {
x__$2.forward.push((((i < links_17429.length))?(links_17429[i]):null));
}

if((i < links_17429.length)){
(links_17429[i] = x__$2);
} else {
links_17429.push(x__$2);
}
...
var i_17431 = (0);
while(true){
if((i_17431 <= self__.level)){
var links_17432 = (update[i_17431]).forward;
if((x__$1 === (((i_17431 < links_17432.length))?(links_17432[i_17431]):null))){
(links_17432[i_17431] = (x__$1.forward[i_17431]));

var G__17433 = (i_17431 + (1));
i_17431 = G__17433;
continue;
} else {
var G__17434 = (i_17431 + (1));
i_17431 = G__17434;
continue;
}
} else {
...
var G__17436 = nx;
var G__17437 = (level__$1 - (1));
x = G__17436;
level__$1 = G__17437;
continue;
} else {
var G__17438 = x;
var G__17439 = (level__$1 - (1));
x = G__17438;
level__$1 = G__17439;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__17441 = nx;
var G__17442 = (level__$1 - (1));
x = G__17441;
level__$1 = G__17442;
continue;
} else {
var G__17443 = x;
var G__17444 = (level__$1 - (1));
x = G__17443;
level__$1 = G__17444;
continue;
}
