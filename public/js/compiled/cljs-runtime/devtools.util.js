...
var len__5769__auto___14572 = arguments.length;
var i__5770__auto___14573 = (0);
while(true){
if((i__5770__auto___14573 < len__5769__auto___14572)){
args__5775__auto__.push((arguments[i__5770__auto___14573]));

var G__14576 = (i__5770__auto___14573 + (1));
i__5770__auto___14573 = G__14576;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__14388_14578 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__14389_14579 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__14390_14580 = true;
var _STAR_print_fn_STAR__temp_val__14391_14581 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__14390_14580);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__14391_14581);

try{var _STAR_print_level_STAR__orig_val__14392_14582 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14393_14583 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14393_14583);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14392_14582);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__14389_14579);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__14388_14578);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq14385){
...
var new_formatters = current_formatters.filter((function (p1__14506_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__14506_SHARP_)));
}));
...
var G__14511_14610 = f;
var target__12090__auto___14611 = G__14511_14610;
if(cljs.core.truth_(target__12090__auto___14611)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14511_14610)].join(''),"\n","target__12090__auto__"].join('')));
}

(target__12090__auto___14611["toString"] = (function (){
...
var G__14515_14613 = "%c%s";
var G__14516_14614 = "color:transparent";
var G__14517_14615 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__14515_14613,G__14516_14614,G__14517_14615) : f.call(null,G__14515_14613,G__14516_14614,G__14517_14615));
...
var vec__14527 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14527,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14527,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__14620__delegate = function (add_fmt,add_args){
...
var G__14620 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__14621__i = 0, G__14621__a = new Array(arguments.length -  1);
while (G__14621__i < G__14621__a.length) {G__14621__a[G__14621__i] = arguments[G__14621__i + 1]; ++G__14621__i;}
  add_args = new cljs.core.IndexedSeq(G__14621__a,0,null);
} 
return G__14620__delegate.call(this,add_fmt,add_args);};
G__14620.cljs$lang$maxFixedArity = 1;
G__14620.cljs$lang$applyTo = (function (arglist__14622){
var add_fmt = cljs.core.first(arglist__14622);
var add_args = cljs.core.rest(arglist__14622);
return G__14620__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq14522){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14523,G__14524,G__14525,seq14522__$3);
}));
...
var seq__14532 = cljs.core.seq(features);
var chunk__14533 = null;
var count__14534 = (0);
var i__14535 = (0);
while(true){
if((i__14535 < count__14534)){
var feature = chunk__14533.cljs$core$IIndexed$_nth$arity$2(null,i__14535);
...
var G__14624 = seq__14532;
var G__14625 = chunk__14533;
var G__14626 = count__14534;
var G__14627 = (i__14535 + (1));
seq__14532 = G__14624;
chunk__14533 = G__14625;
count__14534 = G__14626;
i__14535 = G__14627;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__14532);
if(temp__5804__auto__){
var seq__14532__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__14532__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__14532__$1);
var G__14628 = cljs.core.chunk_rest(seq__14532__$1);
var G__14629 = c__5568__auto__;
var G__14630 = cljs.core.count(c__5568__auto__);
var G__14631 = (0);
seq__14532 = G__14628;
chunk__14533 = G__14629;
count__14534 = G__14630;
i__14535 = G__14631;
continue;
} else {
var feature = cljs.core.first(seq__14532__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__14634 = cljs.core.next(seq__14532__$1);
var G__14635 = null;
var G__14636 = (0);
var G__14637 = (0);
seq__14532 = G__14634;
chunk__14533 = G__14635;
count__14534 = G__14636;
i__14535 = G__14637;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o14565 = temp__5802__auto__;
return (o14565["version"]);
} else {
return null;
}
})() == null);
