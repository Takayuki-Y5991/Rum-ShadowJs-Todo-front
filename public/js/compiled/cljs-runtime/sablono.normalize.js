...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__21788){
var vec__21789 = p__21788;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21789,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21789,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__21792_SHARP_){
return (((p1__21792_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__21792_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__21793,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__21793;
}
});
...
var G__21795 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21795,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__21795;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq21794){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21794));
}));
...
var vec__21798 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__21802 = cljs.core.ffirst(matches);
var fexpr__21801 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__21801.cljs$core$IFn$_invoke$arity$1 ? fexpr__21801.cljs$core$IFn$_invoke$arity$1(G__21802) : fexpr__21801.call(null,G__21802));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21798,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21798,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__21796_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__21796_SHARP_))){
return p1__21796_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__21797_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__21797_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__21804){
...
var tag = first__21807;
var content = seq__21806__$1;
...
var vec__21808 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21808,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21808,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21808,(2),null);
