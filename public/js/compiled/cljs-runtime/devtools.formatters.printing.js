...
var len__5769__auto___13574 = arguments.length;
var i__5770__auto___13575 = (0);
while(true){
if((i__5770__auto___13575 < len__5769__auto___13574)){
args__5775__auto__.push((arguments[i__5770__auto___13575]));

var G__13576 = (i__5770__auto___13575 + (1));
i__5770__auto___13575 = G__13576;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13444){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13445,G__13446,seq13444__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13498_SHARP_){
return (!((cljs.core.meta(p1__13498_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13522__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13525){var _e__12096__auto__ = e13525;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e13528){var _e__12096__auto__ = e13528;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13539 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13540 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13540);

try{var map__13541 = opts;
var map__13541__$1 = cljs.core.__destructure_map(map__13541);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13541__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13539);
}});
...
var temp__5802__auto___13666 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13666)){
var managed_print_level_13668 = temp__5802__auto___13666;
var _STAR_print_level_STAR__orig_val__13551_13671 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13552_13672 = managed_print_level_13668;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13552_13672);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13542_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13542_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13551_13671);
}} else {
job_fn();
}
