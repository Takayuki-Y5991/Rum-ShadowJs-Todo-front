...
return fetch(url,options).then((function (p1__17032_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2((204),p1__17032_SHARP_.status())){
...
return fetch(url,options).then((function (p1__17033_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2((200),p1__17033_SHARP_.status())){
...
return fetch(url,options).then((function (p1__17034_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2((204),p1__17034_SHARP_.status())){
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__17035_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17035_SHARP_),todo_id);
}),todos);
});
clojure_rum_start.core.todo_item = rum.core.lazy_build(rum.core.build_defc,(function (todo){
var vec__17036 = rum.core.use_state(new cljs.core.Keyword(null,"completed","completed",-486056503).cljs$core$IFn$_invoke$arity$1(todo));
var completed_status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17036,(0),null);
var is_completed_status_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17036,(1),null);
var todo_id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(todo);
return daiquiri.core.create_element("li",{'key':todo_id,'style':{'color':(cljs.core.truth_(completed_status)?"green":"red")},'className':"card"},[(function (){var attrs17039 = new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(todo);
return daiquiri.core.create_element("h3",((cljs.core.map_QMARK_(attrs17039))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["todo-content"], null)], null),attrs17039], 0))):{'className':"todo-content"}),((cljs.core.map_QMARK_(attrs17039))?null:[daiquiri.interpreter.interpret(attrs17039)]));
...
var vec__17042 = rum.core.use_state("");
var task = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17042,(0),null);
var set_task_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17042,(1),null);
var vec__17045 = rum.core.use_state(clojure_rum_start.core.create_date());
var limit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17045,(0),null);
var set_limit_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17045,(1),null);
...
var G__17054 = p1__17040_SHARP_.target.value;
return (set_task_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_task_BANG_.cljs$core$IFn$_invoke$arity$1(G__17054) : set_task_BANG_.call(null,G__17054));
}))},[]),daiquiri.core.create_element("span",{'style':{'margin':"0 20px"}},["\u671F\u9650 :"]),daiquiri.core.create_element("input",{'type':"date",'value':limit,'onChange':rum.core.mark_sync_update((function (p1__17041_SHARP_){
var G__17055 = p1__17041_SHARP_.target.value;
return (set_limit_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_limit_BANG_.cljs$core$IFn$_invoke$arity$1(G__17055) : set_limit_BANG_.call(null,G__17055));
...
var G__17056 = clojure_rum_start.core.create_date();
return (set_limit_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_limit_BANG_.cljs$core$IFn$_invoke$arity$1(G__17056) : set_limit_BANG_.call(null,G__17056));
})},[])])]);
...
return daiquiri.core.create_element("div",null,[daiquiri.core.create_element("div",{'className':"heading"},[daiquiri.core.create_element("h1",null,["MY TODO"])]),clojure_rum_start.core.todo_form(),daiquiri.core.create_element("div",null,[daiquiri.core.create_element("ul",{'style':{'listStyle':"none"},'className':"container"},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function clojure_rum_start$core$iter__17059(s__17060){
return (new cljs.core.LazySeq(null,(function (){
var s__17060__$1 = s__17060;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__17060__$1);
if(temp__5804__auto__){
var s__17060__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__17060__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__17060__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__17062 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__17061 = (0);
while(true){
if((i__17061 < size__5522__auto__)){
var todo = cljs.core._nth(c__5521__auto__,i__17061);
cljs.core.chunk_append(b__17062,clojure_rum_start.core.todo_item(todo));

var G__17064 = (i__17061 + (1));
i__17061 = G__17064;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__17062),clojure_rum_start$core$iter__17059(cljs.core.chunk_rest(s__17060__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__17062),null);
}
} else {
var todo = cljs.core.first(s__17060__$2);
return cljs.core.cons(clojure_rum_start.core.todo_item(todo),clojure_rum_start$core$iter__17059(cljs.core.rest(s__17060__$2)));
}
} else {
return null;
}
...
var todos_with_dates = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17063_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__17063_SHARP_,new cljs.core.Keyword(null,"limit_date","limit_date",-1761169423),clojure_rum_start.core.format_date(new cljs.core.Keyword(null,"limit_date","limit_date",-1761169423).cljs$core$IFn$_invoke$arity$1(p1__17063_SHARP_)));
}),clj_json);
